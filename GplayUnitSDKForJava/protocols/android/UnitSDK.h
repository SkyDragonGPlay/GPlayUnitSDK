...
typedef map<string, string> TGoodsInfo;
typedef map<string, TGoodsInfo> TAllGoodsInfo;
...
public:
    ...
    // get user id, if not login, return empty string
     ...
     */
    virtual void payForProduct(string callbackId, map<string, string> info) = 0;
     ...
     */
    virtual void share(string callbackId, map<string, string> info) = 0;

    /**
     * @brief create short cut
     * @param info
     */
    virtual void createShortCut(string callbackId, map<string, string> info) = 0;


    // call synchronized function with name, maybe param
    virtual void callSyncFunc(const char* funcName, TypeParam * param, ...) = 0;
    virtual void callSyncFunc(const char* funcName, vector<TypeParam *> params) = 0;
    virtual string callSyncStringFunc(const char* funcName, TypeParam * param, ...) = 0;
    virtual string callSyncStringFunc(const char* funcName, vector<TypeParam *> params) = 0;
    virtual int callSyncIntFunc(const char* funcName, TypeParam * param, ...) = 0;
    virtual int callSyncIntFunc(const char* funcName, vector<TypeParam *> params) = 0;
    virtual bool callSyncBoolFunc(const char* funcName, TypeParam * param, ...) = 0;
    virtual bool callSyncBoolFunc(const char* funcName, vector<TypeParam *> params) = 0;
    virtual float callSyncFloatFunc(const char* funcName, TypeParam * param, ...) = 0;
    virtual float callSyncFloatFunc(const char* funcName, vector<TypeParam *> params) = 0;
    
    // call asynchrony function with name, maybe param
    virtual void callAsyncFunc(const char* callbackId, const char* funcName, TypeParam * param, ...) = 0;
    virtual void callAsyncFunc(const char* callbackId, const char* funcName, vector<TypeParam *> params) = 0;
